...
//    192.168.1.9
    ...
    public static String GetAddedData =ipv4+"TestAndroid/GetAddedDetail.php";
    public static String GetAddedDataImage =ipv4+"TestAndroid/FetchImage.php?image=";
    public static String Url =ipv4+"TestAndroid/FetchImage/uploads";
}
